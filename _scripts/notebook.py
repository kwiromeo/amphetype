...
def _():
    ...
    return List, combinations, pprint, source_words


@app.cell
def _(List, combinations, pprint, source_words: "List[str]"):
    ...
    lessons = {}
    for pair in pairs:
      pair_words: List[str] = [word for word in source_words if (pair[0] in word and pair[1] in word)]
...
def _(lessons):
    ...
    z_ngram_lesson: str = " ".join(z_ngrams)
    pyperclip.copy(z_ngram_lesson)
    return
